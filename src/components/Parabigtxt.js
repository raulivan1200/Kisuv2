...
import catr from "../../public/catpad.png"
import catf from "../../public/catjump.png"
...
function Parabigtxt() {
  ...
  <div className={styles.c1}>
    ...
    <Image alt="kisu cat" src={cato} placeholder='blur' className={styles.im} width={0} height={0} sizes='(max-width: 768px) 480px, (max-width: 1200px) 20vw, (min-width: 1200px) 40vw' ></Image>
  </div>
  </div>
  <div className={styles.c2}>
    <div className={styles.cardana}>
    <p> 📈 75% of consumers admit to making judgments on a company's credibility based on the company's website design</p>
    <Image alt="kisu cat" src={catt} placeholder='blur' className={styles.im} width={0} height={0} sizes='(max-width: 768px) 480px, (max-width: 1200px) 20vw, (min-width: 1200px) 40vw' ></Image>
   </div>
  </div>
  <div className={styles.c3}>
    <div className={styles.cardana}>
    <p> 📈 Nearly 8 in 10 customers would stop engaging with content that doesn't display well on their device</p>
    <Image alt="kisu cat" src={catr} placeholder='blur' className={styles.im} width={0} height={0} sizes='(max-width: 768px) 480px, (max-width: 1200px) 20vw, (min-width: 1200px) 40vw' ></Image>
   </div>
  </div>
  <div className={styles.c4}>
    <div className={styles.cardana}>
    <p> 📈 Once on a company's homepage, 86% of visitors want to see information about that company's products/services</p>
    <Image alt="kisu cat" src={catf} placeholder='blur' className={styles.im} width={0} height={0} sizes='(max-width: 768px) 480px, (max-width: 1200px) 20vw, (min-width: 1200px) 40vw' ></Image>
    </div>
  </div>
</div>
    </div>
